/* Offline cache — FROZEN LEGACY COPY, scoped to /legacy/.
   ...
   Cache name is prefixed 'legacy-' so it can never collide with the root
   app's cache or the SPA's Workbox caches on the same origin. */
const V='legacy-larch-canyon-2026.08.08-2';
